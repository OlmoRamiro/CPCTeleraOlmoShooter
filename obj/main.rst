                             ...
                             49 ;--------------------------------------------------------
                             50 	.area _CODE
                             51 ;src/main.c:33: void drawSprite(u8 *sprite,int sprite_vertical_pos,int sprite_horizontal_pos,int sprite_width,int sprite_height)
                             52 ;	---------------------------------
   ...
   4130 DD 39         [15]   58 	add	ix,sp
                             59 ;src/main.c:36: pvmem = cpct_getScreenPtr(CPCT_VMEM_START,sprite_horizontal_pos,sprite_vertical_pos);
   4132 DD 56 06      [19]   60 	ld	d, 6 (ix)
   4135 DD 5E 08      [19]   61 	ld	e, 8 (ix)
   ...
   4140 EB            [ 4]   66 	ex	de,hl
                             67 ;src/main.c:37: cpct_drawSprite(sprite,pvmem,sprite_width,sprite_height);
   ...
   415A C9            [10]   82 	ret
                             83 ;src/main.c:41: void main(void) 
                             84 ;	---------------------------------
                             85 ; Function main
                             86 ; ---------------------------------
   415B                      87 _main::
                             88 ;src/main.c:50: cpct_disableFirmware();
   415B CD A3 42      [17]   89 	call	_cpct_disableFirmware
                             90 ;src/main.c:52: cpct_setVideoMode(0);
   415E 2E 00         [ 7]   91 	ld	l, #0x00
   4160 CD 95 42      [17]   92 	call	_cpct_setVideoMode
                             93 ;src/main.c:53: cpct_setPalette(g_palette, 16);
   ...
   41BF F9            [ 6]  147 	ld	sp, hl
                            148 ;src/main.c:86: cpct_waitVSYNC();
   41C0 CD 8D 42      [17]  149 	call	_cpct_waitVSYNC
                            150 ;src/main.c:89: while (1);
   41C3                     151 00102$:
