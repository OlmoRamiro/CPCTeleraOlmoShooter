...
#Modo 0 - Cada byte son 2 pixels
#Modo 1 - Cada byte son 4 pixels
#Modo 2 - Cada byte son 8 pixels
#El ancho del png tiene que ser multiplo de 2,4 u 8 dependiendo del modo
#$(eval $(call IMG2SP, SET_MODE, 0 ))  

#Esto es porque quiero que genere los sprites en la carpeta "sprites" en lugar de en "img"
$(eval $(call IMG2SP, SET_FOLDER, src/sprites))

#Al haber definido PALLETTE arriba, tengo que decirle a IMG2SP que coja esa paleta y no la de por defecto 
#Para convertir los .png en .C 
$(eval $(call IMG2SP, SET_PALETTE_FW, $(PALETTE)))

#Una vez establecida cual es la paleta le digo que la aplique al convertir los png en sprites
$(eval $(call IMG2SP, CONVERT_PALETTE, $(PALETTE), g_palette ))

#Rutas de los png a convertir
#No necesito especificar el alto y ancho porque solo hay un sprite en cada png. 
# w = 0 h = 0
# array = nombre para poder usar el sprite en nuestro codigo
# palette = para convertir la paleta, no lo vamos a usar asi que lo quitamos
# tileset = no lo vamos a usar porque no tenemos tiles

$(eval $(call IMG2SP, CONVERT, img/player-ship.png , 0, 0, sp_player_ship))
$(eval $(call IMG2SP, CONVERT, img/enemy-saurcer.png , 0, 0, sp_enemy_saucer))
$(eval $(call IMG2SP, CONVERT, img/vshot.png , 0, 0, sp_vshot))
